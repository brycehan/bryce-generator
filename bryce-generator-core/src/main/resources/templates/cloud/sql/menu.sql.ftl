...
-- 添加菜单
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, visible, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (${nextId}, '${menuName}管理', 'M', 2, '${moduleName}/${hyphenName}/index', '${moduleName}:${hyphenName}:query', 'ion:apps-sharp', 0, 0, null, 1, 1, null, 1, ${now}, 1, ${now});
