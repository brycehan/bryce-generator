...
drop table brc_gen_datasource;
create table brc_gen_datasource
(
    id          number(20, 0)   default seq_brc_gen_datasource_id.nextval not null,
    conn_name   varchar2(100)   not null,
    db_type     varchar2(50),
    conn_url    varchar2(200),
...
-- 2、字段类型表
drop sequence seq_brc_gen_field_type_id;
create sequence seq_brc_gen_field_type_id;

drop table brc_gen_field_type;
create table brc_gen_field_type
(
    id           number(20, 0)  default seq_brc_gen_field_type_id.nextval not null,
...
-- 3、基类表
drop sequence seq_brc_gen_base_class_id;
create sequence seq_brc_gen_base_class_id;

drop table brc_gen_base_class;
create table brc_gen_base_class
(
    id           number(20, 0)  default seq_brc_gen_base_class_id.nextval not null,
...
drop table brc_gen_table;
create table brc_gen_table
(
    id             number(20, 0)    default seq_brc_gen_table_id.nextval not null,
    ...
    backend_path   varchar2(300),
    frontend_path  varchar2(300),
    module_name    varchar2(100),
    function_name  varchar2(100),
    form_layout    number(2, 0),
    datasource_id  number(20, 0)    not null,
    base_class_id   number(20, 0),
    remark         varchar2(300),
    create_time    date,
    primary key (id)
);
...
comment on column brc_gen_table.module_name is '模块名称';
comment on column brc_gen_table.function_name is '功能名称';
...
-- 5、代码生成表字段
drop sequence seq_brc_gen_table_field_id;
create sequence seq_brc_gen_table_field_id;

drop table brc_gen_table_field;
create table brc_gen_table_field
(
    id              number(20, 0)   default seq_brc_gen_table_field_id.nextval not null,
    table_id        number(20, 0)   not null,
    field_name      varchar2(200)   not null,
    field_type      varchar2(100)   not null,
...
-- 6、项目名变更表
drop sequence seq_brc_gen_project_modify_id;
create sequence seq_brc_gen_project_modify_id;

drop table brc_gen_project_modify;
create table brc_gen_project_modify
(
    id                             number(20, 0)    default seq_brc_gen_project_modify_id.nextval not null,
    project_name                   varchar2(100)    not null,
    project_code                   varchar2(100)    not null,
    project_code_abbreviate        varchar2(100)    not null,
    project_package                varchar2(100)    not null,
    project_path                   varchar2(200)    not null,
    modify_project_name            varchar2(100),
    modify_project_code            varchar2(100),
    modify_project_code_abbreviate varchar2(100),
